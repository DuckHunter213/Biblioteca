...
public interface ReservacionDAO{
     ...
     *
     * @param identificador Se pasa el identificador de la reservación la cual cual va a
     ...
     *
     * @param reservacion Es un objeto de tipo préstamo valido que se va a guardar
     * en la base de datos.
